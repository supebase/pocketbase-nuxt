...
export type CommentStatsResponse<Tlast_user_name = unknown, Tuser_avatars = unknown, Texpand = unknown> = Required<CommentStatsRecord<Tlast_user_name, Tuser_avatars>> & BaseSystemFields<Texpand>
...
export type PostsResponse<Tlink_data = unknown, Texpand = unknown> = Required<PostsRecord<Tlink_data>> & BaseSystemFields<Texpand>
export type UserStatsResponse<Tactive_users_30d = unknown, Ttoday_new_users = unknown, Texpand = unknown> = Required<UserStatsRecord<Tactive_users_30d, Ttoday_new_users>> & BaseSystemFields<Texpand>
